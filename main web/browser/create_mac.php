...
if($origen!= "/browser/stat_mac.php"){
...
$datetime2 = new DateTime('2018-07-15'); //Creamos un objeto DateTime con la fecha de final de curso
...
*/
$note   = '[dispositivo desautorizado OK] ' . $mac_add . ' ' . $fecha_actual . $num_voucher .' >> C:\xampp\logs\log-API.txt';
exec("echo $note");
?>
...
<H4>
<?php	
echo  "Se ha anulado el dispositivo  y creado el siguiente: $num_voucher ";
?>
</H4>
